...
figure('Name','RW Avg Speed');     plot (mean(nodes_speed_mean,1),'r'); 
figure('Name','RW Avg Neighbor');  plot (mean(nghbr,1),'r'); 
figure('Name','RW Density 2D');    scatter(final_pos_x_mean,final_pos_y_mean);
figure('Name','RW Density 3D');    surf(z);
grid on 
